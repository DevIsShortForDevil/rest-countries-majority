<template>
  <svg :height="height" :width="width" viewBox="0 0 64 64" :class="classes">
    <g>
      <circle
        fill-rule="evenodd"
        clip-rule="evenodd"
...
const props = withDefaults(defineProps<{ classes?: string; width?: number; height?: number }>(), {
  classes: 'fill-light-gray dark:fill-dark-gray',
  width: 20,
  height: 20,
});

const { classes, width, height } = toRefs(props);
</script>
